  ...
  function drawQrcode(oQRCode) {
    for (var row = 0; row < nCount; row++) {
      for (var col = 0; col < nCount; col++) {
        ...
        if (eye) {
          dColor =
            _htOption[eye.type] || _htOption[eye.type.substring(0, 2)] || _htOption.colorDark;
    ...
    if (_htOption.title) {
      ...
      _oContext.fillText(
        _htOption.title,
        t._canvas.width / 2,
        this._htOption.quietZone + this._htOption.titleTop
      );
    }
    ...
    if (_htOption.subTitle) {
      ...
      _oContext.fillText(
        _htOption.subTitle,
        t._canvas.width / 2,
        this._htOption.quietZone + this._htOption.subTitleTop
      );
    }
    ...
    if (_htOption.logo) {
      ...
      function generateLogoImg(img) {
        ...
        if (_htOption.logoMaxWidth || _htOption.logoMaxHeight) {
          ...
          imgContainerY =
            (_htOption.height + _htOption.titleHeight + _htOption.quietZone * 2 - imgContainerH) /
            2;
        }
